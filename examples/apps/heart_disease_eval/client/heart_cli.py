...
# Heart Evaluation CLI Client for use in submitting data to worker.
...
def ParseCommandLine(args) :
	...
	parser.add_argument("-i", "--in_data",
		help="Heart evaluation input data " +
			" as \"Data: \" followed by 14 space-separated numbers. " +
			"For example: " +
			"\"Data: 35 0 1 67 102 125 1 95 0 10 1 1 3 1\"",
		nargs="+",
		type=str)
	parser.add_argument("-g", "--generate",
		help="Generate random heart evaluation input data",
		action="store_true")
	...
	if options.in_data:
		...
		print("DEBUG: Manual heart disease evaluation input:\n{}\n" \
			.format(in_data))
		if options.generate:
			logger.info("Both -i/--in_data and -g/--generate " +
				"cannot be used.\n");
	else:
		# use generated random data if no explicit input data
		options.in_data = in_data = "['Data: 25 10 1 67 102 125 1 95 5 10 1 11 36 1']"

		print("DEBUG: Generated heart disease evaluation input:\n{}\n" \
			.format(in_data))
		logger.info("Generated heart disease evaluation input:\n{}\n" \
			.format(in_data))
