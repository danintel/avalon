...
class resultWindow(tk.Toplevel):
	...
	def evaluate(self, message):
		...
		self.result_text.set("Waiting for hospital evaluation result...")
		self.update()
...
def gui_main():
	...
	root = tk.Tk()
	root.title("HOSPITAL HEART DISEASE APPLICATION")
	root.config(background=BACKGROUND)

	# Display image
	imageFile = TCFHOME + "/examples/apps/heart_disease_eval/client/images/ecg.jpg"
	...
	def evaluate():
		...
		message = "Hospital heart disease evaluation data: "
